...
public class TableMapping
{
    ...
    public string GetColumnName(IProperty property) => FindColumn(property).Name;
    ...
    public IEnumerable<string> GetPrimaryKeyColumns() =>
        EntityType.FindPrimaryKey().Properties.Select(o => o.GetColumnName(StoreObjectIdentifier));
