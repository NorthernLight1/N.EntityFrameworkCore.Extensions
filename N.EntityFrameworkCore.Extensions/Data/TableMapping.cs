...
namespace N.EntityFrameworkCore.Extensions
{
    public class TableMapping
    {
        ...
        public string[] GetColumns(bool includeAutoGenerated=false)
        {
            return EntityType.GetProperties().Where(o => includeAutoGenerated || o.ValueGenerated == ValueGenerated.Never).Select(o => string.Format("[{0}]",o.Name)).ToArray();
        }
