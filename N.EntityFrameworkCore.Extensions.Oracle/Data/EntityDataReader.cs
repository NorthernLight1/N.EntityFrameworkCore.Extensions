...
internal sealed class EntityDataReader<T> : IDataReader
{
    ...
    public Type GetFieldType(int i)
    {
        ...
        return TableMapping.Properties[i].ClrType;
    }
    ...
    {
        if (i == tableFieldCount)
            return Constants.InternalId_ColumnName;

        return TableMapping.GetColumnName(TableMapping.Properties[i]);
    }
    ...
    public object GetValue(int i)
    {
        ...
        {
            return selectors[i](FindEntry(enumerator.Current)) ?? DBNull.Value;
        }
