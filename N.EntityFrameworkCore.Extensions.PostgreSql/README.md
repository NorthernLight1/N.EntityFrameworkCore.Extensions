## N.EntityFrameworkCore.Extensions.PostgreSql

[![latest version](https://img.shields.io/nuget/v/N.EntityFrameworkCore.Extensions.PostgreSql)](https://www.nuget.org/packages/N.EntityFrameworkCore.Extensions.PostgreSql) [![downloads](https://img.shields.io/nuget/dt/N.EntityFrameworkCore.Extensions.PostgreSql)](https://www.nuget.org/packages/N.EntityFrameworkCore.Extensions.PostgreSql)

High-performance bulk data extensions for Entity Framework Core — **PostgreSql** provider. Extends your `DbContext` with bulk operations, query-based DML, CSV export, and utility helpers — all without loading entities into memory.
