...
public class SqlQuery
{
    ...
    public int Count()
    {
        ...
        return Convert.ToInt32(database.ExecuteScalar(countSqlText, Parameters));
    }
    public async Task<int> CountAsync(CancellationToken cancellationToken = default)
    {
        string countSqlText = SqlBuilder.Parse(SqlText).Count();
        return Convert.ToInt32(await database.ExecuteScalarAsync(countSqlText, Parameters, null, cancellationToken));
    }
