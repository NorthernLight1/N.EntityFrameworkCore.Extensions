    ...
    internal Func<object, object> GetValueFromProvider(IProperty property)
    {
        ...
        return value =>
        {
            ...
            if (valueConverter != null)
                return valueConverter.ConvertFromProvider(value);
            ...
            if (targetType == typeof(bool))
                return value switch
                {
                    ...
                    string stringValue when long.TryParse(stringValue, out long parsedLong) => parsedLong != 0,
                    _ => Convert.ToBoolean(value)
                };
            if (targetType == typeof(DateTime) && value is string dateTimeString)
                return DateTime.Parse(dateTimeString);
            if (targetType == typeof(DateTimeOffset) && value is string dateTimeOffsetString)
            ...
            if (value is IConvertible && typeof(IConvertible).IsAssignableFrom(targetType) && value.GetType() != targetType)
